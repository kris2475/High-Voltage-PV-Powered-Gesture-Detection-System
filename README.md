...
**Li-Ion Success:**  
Higher ESR and battery-like behavior created a smoother, resistive-like load profile. This allowed stable MPPT operation at 69–73 V.
...
If $R_{in}$ is too small → PV voltage collapses (explains EDLC instability).
